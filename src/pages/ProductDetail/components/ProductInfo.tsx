            ...
            <>
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  className="flex-[0.5] sm:flex-[1.4] py-4 rounded-xl font-black uppercase text-xs sm:text-sm tracking-[0.2em] shadow-lg transition-all flex items-center justify-center gap-2 bg-gradient-to-r from-primary-500 to-purple-600 text-white hover:scale-[1.02] active:scale-[0.98]"
                >
                  BUY <ChevronRight size={20} />
                </button>
              </div>
            </>
          );
