    ...
    <form onSubmit={handleRegister} className="space-y-6 text-left">
      <div className="space-y-4">
        <div className="space-y-1.5 group">
          <label className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1 group-focus-within:text-primary-500 transition-colors">Full Name</label>
          <div className="relative">
            <input
              ...
              className="w-full bg-secondary/80 dark:bg-slate-800 text-foreground border border-border rounded-xl py-3.5 pl-11 pr-4 focus:ring-2 focus:ring-primary-500 transition-all outline-none font-bold"
              placeholder="John Doe"
            />
            <User className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground group-focus-within:text-primary-500 transition-colors" size={20} />
          </div>
        </div>

        <div className="space-y-1.5 group">
          <label className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1 group-focus-within:text-primary-500 transition-colors">Email</label>
          <div className="relative">
            <input
              type="email"
              required
        ...
        <div className="space-y-1.5 group">
          <label className="text-xs font-black text-muted-foreground uppercase tracking-widest ml-1 group-focus-within:text-primary-500 transition-colors">Password</label>
          <div className="relative">
            <input
              type="password"
              required
