...
export const UserDetail: React.FC<UserDetailProps> = ({
  ...
  const executeBoost = async () => {
    ...
    try {
      ...
      const skippedNote = unpublishedCount > 0 ? ` (${unpublishedCount} unpublished skipped)` : '';
      toast.success(`✅ Boosted ${total} products (${shopLabel}) with ${boostLabel}${skippedNote}`, { duration: 6000 });
    } finally {
      setIsSavingBoost(false);
      setBoostProgress(null);
    }
