    ...
    <div className="space-y-6">
      ...
      {isSelectMode && (
        <div className="sticky bottom-3 z-50 px-0">
          <div className="bg-slate-900 dark:bg-white rounded-2xl shadow-2xl border border-slate-700/60 dark:border-slate-200 overflow-hidden">
            <div className="flex items-stretch divide-x divide-slate-700/60 dark:divide-slate-200">
              ...
              <div className="flex flex-col items-center justify-center px-3 sm:px-4 py-2.5 min-w-[52px]">
                ...
                <span className="text-base font-black text-white dark:text-slate-900 leading-none">{selectedIds.length}</span>
              </div>
              ...
              <button
                ...
                className="flex-1 flex flex-col items-center justify-center px-2 sm:px-4 py-2.5 text-[8px] font-black uppercase tracking-widest text-slate-300 dark:text-slate-600 hover:bg-slate-800 dark:hover:bg-slate-50 transition-colors gap-0.5"
              >
                <Check size={13} strokeWidth={3} />
                <span className="leading-none">
                  {products.filter(p => p.is_published).length > 0 &&
                    products.filter(p => p.is_published).every(p => selectedIds.includes(p.id))
                    ? 'Desel.' : 'All'}
                </span>
              </button>
              ...
              <button
                ...
                className="flex-1 flex flex-col items-center justify-center px-2 sm:px-4 py-2.5 text-[8px] font-black uppercase tracking-widest text-slate-300 dark:text-slate-600 hover:bg-slate-800 dark:hover:bg-slate-50 transition-colors gap-0.5 disabled:opacity-30"
              >
