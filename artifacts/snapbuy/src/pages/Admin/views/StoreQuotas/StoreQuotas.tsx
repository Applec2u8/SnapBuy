...
export const StoreQuotas = () => {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from('store_quotas').insert({
        ...
        auto_import_count: autoImportCount,
      });
      if (error) throw error;
  ...
  const handleRevokeCode = async (quotaId: string) => {
    ...
    try {
      ...
      // 2. Reset the shop's product_limit to 0 and clear expiry
      ...
      toast.success('Quota code revoked and shop limit reset to 0');
      setConfirm(null);
      fetchQuotas();
  ...
  return (
    <div className="space-y-6">
      ...
      <GenerateCodeModal
        ...
        setAutoImportCount={setAutoImportCount}
        creating={creating}
      />
