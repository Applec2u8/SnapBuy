      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {statCards.map((card, idx) => (
          <motion.div 
            ...
            className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group relative overflow-hidden text-left"
          >
            ...
            <div className="flex justify-between items-start mb-4 relative z-10">
              <div className={`p-3 rounded-2xl ${card.color} text-white shadow-lg ${card.color}/20 group-hover:scale-110 transition-transform`}>
                {card.icon}
              </div>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">{card.value}</h3>
            </div>
          </motion.div>
        ))}
      </div>
