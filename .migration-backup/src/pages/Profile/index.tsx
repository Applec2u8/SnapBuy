...
const Profile = () => {
  ...
  const sections = [
    {
      title: t('my_purchases', 'My Purchases'),
      items: [
        { label: t('my_orders', 'My Orders'), icon: <Package size={18} />, color: "bg-blue-500", to: '/orders' },
        { label: t('my_wishlist', 'Wishlist'), icon: <Heart size={18} />, color: "bg-red-500", to: '/wishlist' },
        { label: t('my_wallet', 'Wallet'), icon: <Wallet size={18} />, color: "bg-orange-500", to: '/wallet' },
      ]
    },
    {
      title: t('manage_account', 'MANAGE ACCOUNT'),
      items: [
        { label: t('my_profile', 'My Profile'), icon: <User size={18} />, color: "bg-slate-500", to: '/profile/edit' },
        ...(profile?.role === 'admin' ? [{ label: 'Admin Panel', icon: <Shield size={18} />, color: "bg-primary-500", to: '/admin' }] : []),
        { label: t('account_security', 'Account Security'), icon: <Shield size={18} />, color: "bg-indigo-500", to: '/security' },
