        ...
        {quotasLoading ? (
          ...
          >
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              {quota.is_used ? (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 text-[9px] font-black uppercase shrink-0">
                  <CheckCircle size={9} /> Used
                </span>
              ) : (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-green-100 dark:bg-green-500/20 text-green-600 dark:text-green-400 text-[9px] font-black uppercase shrink-0">
                  Available
                </span>
              )}
            </div>
