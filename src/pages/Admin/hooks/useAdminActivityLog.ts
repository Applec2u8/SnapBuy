...
export type ActivityActionType =
  ...
  | 'delete_all_bots'
  | 'add_emailjs_config'
  | 'toggle_emailjs_config'
  | 'delete_emailjs_config';

export type ActivityTargetType = 'product' | 'user' | 'database' | 'bot' | 'system' | 'shop' | 'settings' | 'quota';
