  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Customers', count: stats.customers, icon: User, color: 'text-blue-500 bg-blue-500/10 border-blue-500/20' },
          { label: 'Vendors', count: stats.vendors, icon: Store, color: 'text-amber-500 bg-amber-500/10 border-amber-500/20' },
          { label: 'Admins', count: stats.admins, icon: Shield, color: 'text-purple-500 bg-purple-500/10 border-purple-500/20' }
        ].map((item) => {
          ...
          return (
            <motion.div
              ...
              className="p-6 bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-black text-slate-900 dark:text-white mt-2 leading-none">{item.count}</p>
                </div>
              </div>
            </motion.div>
          );
      ...
      {/* Main Section */}
      <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm p-6 sm:p-8 space-y-6">
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          ...
          <div className="px-4 py-2 bg-slate-50 dark:bg-slate-950/50 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center gap-2">
